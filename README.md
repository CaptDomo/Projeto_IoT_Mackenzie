...
O código principal está localizado na pasta `.zip` e foi desenvolvido na Arduino IDE. O arquivo principal `sistema_monitoramento_temperatura_umidade.ino` inclui os módulos de conexão Wi-Fi, configuração do MQTT e funções de coleta de dados e controle do relé.
